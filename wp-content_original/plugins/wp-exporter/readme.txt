...
<strong>Add Export menu at WordPress admin bar in edit page</strong><br />
Put this defined constant in wp-config.php or theme functions.php<br />
<pre>define('WP_EXPORTER_ADMIN_BAR', true);</pre>

<strong>Change exported post status</strong><br />
Put this defined constant in wp-config.php or theme functions.php<br />
<pre>define('WP_EXPORTER_POST_STATUS', 'draft');</pre><br />
For more post statuses please read this documentation https://codex.wordpress.org/Post_Status#Default_Statuses
